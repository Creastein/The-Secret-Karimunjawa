...
export const ROOMS: Room[] = [
  ...
  },
  {
    ...
    imageUrl: '/assets/TivoliGarden/TG1.webp',
    gallery: [
      '/assets/TivoliGarden/TG1.webp',
      '/assets/TivoliGarden/TG2.webp',
      '/assets/TivoliGarden/TG3.webp',
      '/assets/TivoliGarden/TG4.webp',
      '/assets/TivoliGarden/TG5.webp',
      '/assets/TivoliGarden/TG6.webp',
      '/assets/TivoliGarden/TG7.webp',
      '/assets/TivoliGarden/TG8.webp',
      '/assets/TivoliGarden/TG9.webp',
      '/assets/TivoliGarden/TG10.webp',
      '/assets/TivoliGarden/TG11.webp',
    ],
    features: ['Private Garden', 'Garden View', 'Flexible Bedding', 'Daily Housekeeping'],
    startingPrice: 1600000,
    maxPrice: 2500000,
    lowSeasonPrice: 1600000,
    highSeasonPrice: 2500000,
  }
];
...
export const NEARBY_TABS: NearbyTab[] = [
  {
    ...
    places: [
      { name: 'Pantai Batu Topeng', category: 'Landmark', distance: '786m', categoryColor: '#1967D2' },
      { name: 'Bukit Maming', category: 'Landmark', distance: '1.2km', categoryColor: '#1967D2' },
      { name: 'Tanjung Gelam', category: 'Landmark', distance: '1.7km', categoryColor: '#1967D2' },
      { name: 'Syamsinar', category: 'Restoran', distance: '2.3km', categoryColor: '#B31412' },
      { name: 'Whaleys Cafe', category: 'Restoran', distance: '2.6km', categoryColor: '#B31412' },
    ],
  },
  {
    id: 'culinary',
    ...
    places: [
      { name: 'Syamsinar', category: 'Restoran', distance: '2.3km', categoryColor: '#B31412' },
      { name: 'Whaleys Cafe', category: 'Restoran', distance: '2.6km', categoryColor: '#B31412' },
      { name: 'Alun-alun & Pasar Ikan', category: 'Kuliner Malam', distance: '2.8km', categoryColor: '#B31412' },
      { name: 'Basa-basi Karimunjawa', category: 'Restoran', distance: '3.1km', categoryColor: '#B31412' },
      { name: 'Eat & Meet Restaurant', category: 'Restoran', distance: '4km', categoryColor: '#B31412' },
      { name: 'Hakuna Matata Resto', category: 'Restoran', distance: '4.2km', categoryColor: '#B31412' },
      { name: 'Saung Odang', category: 'Restoran', distance: '4.5km', categoryColor: '#B31412' },
    ],
  },
  {
    id: 'airport',
    ...
    places: [
      { name: 'Bandar Udara Dewadaru', category: 'Bandara', distance: '8km', categoryColor: '#1967D2' },
    ],
  },
  {
    id: 'transport',
    ...
    places: [
      { name: 'Pelabuhan Karimunjawa', category: 'Pelabuhan', distance: '4.9km', categoryColor: '#1967D2' },
    ],
  },
  {
    id: 'landmarks',
    ...
    places: [
      { name: 'Pantai Batu Topeng', category: 'Pantai', distance: '786m', categoryColor: '#1967D2' },
      { name: 'Bukit Maming', category: 'View Point', distance: '1.2km', categoryColor: '#1967D2' },
      { name: 'Tanjung Gelam', category: 'Pantai', distance: '1.7km', categoryColor: '#1967D2' },
      { name: 'Alun-alun Karimunjawa', category: 'Park', distance: '2.8km', categoryColor: '#137333' },
      { name: 'Bukit Love', category: 'View Point', distance: '4.6km', categoryColor: '#1967D2' },
      { name: 'Bukit Bendera', category: 'View Point', distance: '4.8km', categoryColor: '#1967D2' },
      { name: 'Pelabuhan Karimunjawa', category: 'Pelabuhan', distance: '4.9km', categoryColor: '#1967D2' },
      { name: 'Bukit Joko Tuwo', category: 'View Point', distance: '5.1km', categoryColor: '#1967D2' },
      { name: 'Pantai Bobi', category: 'Pantai', distance: '5.4km', categoryColor: '#1967D2' },
      { name: 'Pantai Nirwana', category: 'Pantai', distance: '5.9km', categoryColor: '#1967D2' },
      { name: 'Pantai Pancuran', category: 'Pantai', distance: '6.3km', categoryColor: '#1967D2' },
      { name: 'Pantai Anora', category: 'Pantai', distance: '11.5km', categoryColor: '#1967D2' },
    ],
  },
];
