    ...
    <section id="home" className="relative min-h-[95vh] lg:min-h-screen">
      ...
      >
        <div className="relative z-10 flex items-end lg:items-center px-5 md:px-12 lg:px-16 py-10 md:py-16 lg:py-24 order-2 lg:order-1">
          ...
          >
            <motion.div variants={heroFadeUp} custom={0} className="flex items-center gap-4 mb-6">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-charcoal leading-[1.05]">
              <motion.span variants={heroFadeUp} custom={1} className="block">Island Paradise</motion.span>
              <motion.span variants={heroFadeUp} custom={2} className="block font-light italic text-tide">Hidden in Nature</motion.span>
            </h1>

            <motion.p variants={heroFadeUp} custom={3} className="mt-6 text-sm md:text-base text-ink/70 leading-relaxed">
            ...
            <motion.div variants={heroFadeUp} custom={4} className="mt-10 flex flex-wrap items-center gap-4">
              <a href="#contact" className="bg-charcoal text-white px-6 py-3 text-[11px] uppercase tracking-[0.3em] hover:bg-teak-accent transition-colors">
                Reserve Your Stay
              </a>
              <a href="#gallery" className="px-6 py-3 text-[11px] uppercase tracking-[0.3em] border border-ink/20 text-ink hover:border-ink/60 transition-colors">
                View the Retreat
              </a>
            </motion.div>
          </motion.div>
        ...
        <div className="relative overflow-hidden min-h-[50vh] lg:min-h-0 order-1 lg:order-2">
          <img
            ...
            loading="eager"
          />
          <div ref={overlayRef} className="absolute inset-0 bg-gradient-to-t from-ink/70 via-ink/30 to-transparent" />
