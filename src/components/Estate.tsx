          ...
          <div ref={headerRef}>
            ...
            <div ref={statsRef} className="grid grid-cols-3 gap-8 border-t border-stone-300 pt-8">
              <div data-estate-stat className="text-center">
                <span className="block font-serif text-3xl md:text-4xl text-charcoal mb-1">750<span className="text-sm align-top">m²</span></span>
                <span className="text-[10px] tracking-[0.2em] uppercase text-stone-400">Land Size</span>
              </div>
              <div data-estate-stat className="text-center">
                <span className="block font-serif text-3xl md:text-4xl text-charcoal mb-1">4</span>
                <span className="text-[10px] tracking-[0.2em] uppercase text-stone-400">Suites</span>
              </div>
              <div data-estate-stat className="text-center">
                <span className="block font-serif text-3xl md:text-4xl text-charcoal mb-1">15<span className="text-sm align-top">m</span></span>
