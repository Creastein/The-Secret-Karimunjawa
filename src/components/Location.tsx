  ...
  return (
    <Section id="location" className="bg-sand" fullWidth>
      <div ref={sectionRef} className="flex flex-col-reverse lg:flex-row h-auto lg:h-[600px]">
        ...
        <div className="w-full lg:w-2/3 h-[300px] sm:h-[400px] lg:h-auto relative group overflow-hidden">
          <iframe
        ...
        {/* Right: Curated Guide */}
        <div ref={infoRef} className="w-full lg:w-1/3 bg-white p-8 md:p-12 lg:p-16 flex flex-col justify-center border-l border-stone-200">
