  ...
  return (
    <Section id="gallery" className="bg-stone-50" fullWidth>
      <div className="container mx-auto px-6 md:px-12 py-20">
        ...
        {/* Header & Tabs */}
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16 border-b border-stone-200 pb-6">
          <div>
          ...
          <div className="flex flex-wrap gap-6 md:gap-8">
            {categories.map((cat) => (
              <button
                ...
                className={`text-[11px] uppercase tracking-widest transition-all duration-300 pb-1 border-b-2 ${
                  activeCategory === cat 
